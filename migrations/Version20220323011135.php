 ...
 */
final class Version20220323011135 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE relation (id INT AUTO_INCREMENT NOT NULL, mined INT DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, coin VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
